...
void V4bit_alu::traceChg(VerilatedVcd* vcdp, void* userthis, uint32_t code) {
...
void V4bit_alu::traceChgThis(V4bit_alu__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
...
void V4bit_alu::traceChgThis__2(V4bit_alu__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    V4bit_alu* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    int c = code;
    if (0 && vcdp && c) {}  // Prevent unused
    // Body
...
void V4bit_alu::traceChgThis__3(V4bit_alu__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    V4bit_alu* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    int c = code;
    if (0 && vcdp && c) {}  // Prevent unused
    // Body
