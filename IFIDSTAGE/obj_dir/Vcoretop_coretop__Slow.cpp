...
void Vcoretop_coretop___initial__TOP__coretop__1(Vcoretop_coretop* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcoretop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vcoretop_coretop___initial__TOP__coretop__1\n"); );
    // Body
...
void Vcoretop_coretop___ctor_var_reset(Vcoretop_coretop* vlSelf) {
    ...
    vlSelf->__PVT__decode0__DOT__reg_data1_i = VL_RAND_RESET_I(32);
    vlSelf->__PVT__decode0__DOT__reg_data2_i = VL_RAND_RESET_I(32);
    vlSelf->__PVT__decode0__DOT__reg_addr1_o = VL_RAND_RESET_I(5);
    vlSelf->__PVT__decode0__DOT__reg_addr2_o = VL_RAND_RESET_I(5);
