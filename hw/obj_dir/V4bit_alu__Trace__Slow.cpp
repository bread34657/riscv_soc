...
void V4bit_alu::trace(VerilatedVcdC* tfp, int, int) {
    tfp->spTrace()->addCallback(&V4bit_alu::traceInit, &V4bit_alu::traceFull, &V4bit_alu::traceChg, this);
}
void V4bit_alu::traceInit(VerilatedVcd* vcdp, void* userthis, uint32_t code) {
    // Callback from vcd->open()
    V4bit_alu* t = (V4bit_alu*)userthis;
    V4bit_alu__Syms* __restrict vlSymsp = t->__VlSymsp;  // Setup global symbol table
...
void V4bit_alu::traceFull(VerilatedVcd* vcdp, void* userthis, uint32_t code) {
...
void V4bit_alu::traceInitThis(V4bit_alu__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
...
void V4bit_alu::traceFullThis(V4bit_alu__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    V4bit_alu* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    int c = code;
    if (0 && vcdp && c) {}  // Prevent unused
    // Body
...
void V4bit_alu::traceInitThis__1(V4bit_alu__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    V4bit_alu* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    int c = code;
    if (0 && vcdp && c) {}  // Prevent unused
    // Body
...
void V4bit_alu::traceFullThis__1(V4bit_alu__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    V4bit_alu* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    int c = code;
    if (0 && vcdp && c) {}  // Prevent unused
    // Body
