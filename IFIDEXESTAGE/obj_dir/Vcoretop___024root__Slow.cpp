...
void Vcoretop_coretop___initial__TOP__coretop__2(Vcoretop_coretop* vlSelf) VL_ATTR_COLD;
...
void Vcoretop___024root___eval_initial(Vcoretop___024root* vlSelf) {
    ...
    Vcoretop_coretop___initial__TOP__coretop__2((&vlSymsp->TOP__coretop));
    vlSelf->__Vm_traceActivity[1U] = 1U;
    vlSelf->__Vm_traceActivity[0U] = 1U;
}

void Vcoretop_coretop___settle__TOP__coretop__3(Vcoretop_coretop* vlSelf) VL_ATTR_COLD;
...
void Vcoretop___024root___eval_settle(Vcoretop___024root* vlSelf) {
    ...
    // Body
    Vcoretop_coretop___settle__TOP__coretop__3((&vlSymsp->TOP__coretop));
    vlSelf->__Vm_traceActivity[1U] = 1U;
    vlSelf->__Vm_traceActivity[0U] = 1U;
}
